...
proc freezeTBProc { argsList } {
  ...
  if { [lindex $::tcl_platform(os) 0] eq "Windows" } {
      ...
      if { $status eq 0 } {
         ...
         set freezeTBPath [file join $appData "freezeTB" "freezeTB.exe" ] ; # build alternate freezeTB path
         ...
         if { $status eq 0 } {
            ...
            set freezeTBPath [file join $programFiles "freezeTB" "freezeTB.exe" ] ; # build alternate freezeTB path
