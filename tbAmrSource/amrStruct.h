...
'  o fun-09: read_2021_WhoAmrCsv (TODO: UPDATE)
...
#define blankAmrStruct(amrStructPtr){\
   ...
   (amrStructPtr)->dirFlag = def_amrST_forwardDir;\
...
static struct amrStruct * read_2023_WhoAmrTsv(
   FILE *whoMasterFILE,  /*Master tab as tsv*/
   FILE *whoIndicieFILE, /*genome indicie tab as tsv*/
