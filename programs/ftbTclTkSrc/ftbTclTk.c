...
#define def_amrOutPercSup_ftbTclTk 0.1
#define def_mkGraph_ftbTclTk 1 /*1 is yes*/
...
initTK_ftbTclTk(
   ...
   *     - spoligotype minimum depth
   *   o fun03 sec03 sub06 cat06:
   *     - spoligotype minimum percent depth
   *   o fun03 sec03 sub06 cat07:
   *     - spoligotype maximum edit distance error
   \*****************************************************/
   ...
   tmpStr +=
      cpLine_ulCp(
         tmpStr,
         (signed char *) "variable glob_spolMinDepth "
      );
   numToStr(tmpStr, def_minDepth_tbSpolDefs);
   ...
   { /*If: error*/
      fprintf(
         stderr,
         "%s%sspoligotype minimum depth setup error%s",
         Tcl_GetStringResult(tclInterpSTPtr),
         str_endLine,
         str_endLine
      );
   ...
   tmpStr +=
      cpLine_ulCp(
         tmpStr,
         (signed char *) "variable glob_spolMinPercDepth "
      );
   double_numtoStr(tmpStr,def_minPercDepth_tbSpolDefs,2);
   ...
   { /*If: error*/
      fprintf(
         stderr,
         "%s%sspoligo min percent depth setup error%s",
         Tcl_GetStringResult(tclInterpSTPtr),
         str_endLine,
         str_endLine
      );
   ...
   tmpStr +=
      cpLine_ulCp(
         tmpStr,
         (signed char *) "variable glob_spolMaxDist "
      );
   numToStr(tmpStr, def_maxDist_tbSpolDefs);
   ...
   { /*If: error*/
      fprintf(
         stderr,
         "%s%sspoligotype max distance setup error%s",
         Tcl_GetStringResult(tclInterpSTPtr),
         str_endLine,
         str_endLine
      );
