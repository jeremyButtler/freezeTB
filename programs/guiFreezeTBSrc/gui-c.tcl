   ...
   ---                                                 \n\
         ...
         # set up databases                            \n\
                                                       \n\
         set tbCmd [list \"-prefix\" $glob_prefix] ;   \n\
         lappend tbCmd \"-ref\" $glob_refFa ;          \n\
         ...
         lappend tbCmd \"-db-spoligo\" $glob_spolDb ;  \n\
                                                       \n\
         if { $glob_mask ne 0 } {                      \n\
            lappend tbCmd \"-mask\" $glob_spolDb ;     \n\
         } else {                                      \n\
            lappend tbCmd \"-mask -\" ;                \n\
         ...
         lappend tbCmd \"-min-ins-q\" $glob_insq ;     \n\
         lappend tbCmd \"-min-snp-sup\" ;              \n\
         lappend tbCmd $glob_basePerc ;                \n\
         lappend tbCmd \"-min-ins-sup\" $glob_insPerc ;\n\
         lappend tbCmd \"-min-del-sup\" $glob_delPerc ;\n\
                                                       \n\
         #+++++++++++++++++++++++++++++++++++++++++++++\n\
         ...
         #+++++++++++++++++++++++++++++++++++++++++++++\n\
                                                       \n\
         if { [catch {eval freezeTB $tmCmd } out] } {  \n\
            ---tk_messageBox                           \n\
