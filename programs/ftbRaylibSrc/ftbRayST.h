...
typedef struct gui_ftbRayST
{
   ...
   signed int closeSpolGuiIdSI;
      /*close spoligotype GUI button*/
   ...
   /*_______________close_spoligotypes_GUI______________*/
   signed int closeSpolTblIdSI;
   signed int closeSpolLabIdSI;
   struct listBox_rayWidg *closeSpolListSTPtr;
