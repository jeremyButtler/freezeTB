...
uint8_t parseFastqHeader(
   ...
   \~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    ...
    uint8_t charBit = 0;
    unsigned long startPosUL = 0;

    #if defOSBit == 64
      int *tmpI = 0;
    #elif defOSBIT == 32
      short *tmpI = 0; // 32 bit os
    #elif defOSBIT == 16
      char *tmpI = 0; // 16 bit os
    #endif
    ...
    { // If at the end of the buffer
        if(*lenInUL < buffSizeUI) return 1;
          // This fastq file has an invalid entry
        ...
        *elmILPtr = 0;
        ...
        { // while have room in the current long
            ...
            { // If I need to get new input
                // Check if have more fastq entry
